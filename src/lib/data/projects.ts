...
export const projects: Project[] = [
  {
    ...
    description: {
      ...
      "pt-BR":
        "Um e-commerce moderno com Next.js, React, Tailwind e PostgreSQL, com carrinho, checkout Stripe e autenticação.",
    },
  ...
  },
  {
    ...
    description: {
      ...
      "pt-BR":
        "App de finanças pessoais com resumos diários de gastos e gráficos para entender onde o dinheiro vai.",
    },
