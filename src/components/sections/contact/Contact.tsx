...
export default function ContactSection() {
  return (
    ...
    >
      <motion.div
        className="scroll-mt-24 max-w-6xl mx-auto min-h-[calc(100svh-56px)] lg:min-h-screen
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 items-start gap-8 md:gap-12">
          ...
          >
            ...
            <div className="space-y-4">
              <div
                className="group flex items-start gap-4 rounded-xl border border-gray-200 bg-white
              ...
              >
                <div
                  className="flex h-11 w-11 items-center justify-center rounded-lg
                                ...
                                dark:bg-purple-950 dark:text-purple-300 dark:group-hover:bg-purple-900 transition"
                >
                  <Mail />
                </div>
                <div>
