            ...
            <div className="p-5 sm:p-6 space-y-3">
              ...
              <div className="pt-2">
                <Link
                  ...
                  className="inline-flex items-center gap-1.5 text-sm font-medium text-purple-600 hover:text-purple-700 focus:outline-none focus:ring-2 focus:ring-purple-300 rounded"
                >
